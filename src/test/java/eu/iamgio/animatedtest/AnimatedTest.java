...
public class AnimatedTest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Animated animated = new Animated(pane,
                new AnimatedOpacity()
                        .custom(settings -> settings.withDuration(Duration.seconds(2.4)))
                        .onAnimationStarted(e -> System.out.println("Started, interrupted = " + e.isInterrupted()))
                        .onAnimationEnded(e -> System.out.println("Ended, interrupted = " + e.isInterrupted())),
